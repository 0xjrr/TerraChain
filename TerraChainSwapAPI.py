...
# # https://lcd.terra.dev/terra/market/v1beta1/swap?offer_coin=10000000uusd&ask_denom=uluna
...
# response = requests.get("https://lcd.terra.dev/terra/market/v1beta1/swap?offer_coin=10000000uusd&ask_denom=uluna")


# # https://lcd.terra.dev/terra/wasm/v1beta1/contracts/terra1tndcaqxkpc5ce9qee5ggqf430mr2z3pefe5wj6/store?query_msg=eyJwb29sIjp7fX0%3D
# # payload = eyJwb29sIjp7fX0=




# # https://lcd.terra.dev/terra/wasm/v1beta1/contracts/terra1m6ywlgn6wrjuagcmmezzz2a029gtldhey5k552/store?query_msg=eyJwb29sIjp7fX0%3D
# # query_msg: eyJwb29sIjp7fX0=


# response = requests.get("https://lcd.terra.dev/terra/wasm/v1beta1/contracts/terra1m6ywlgn6wrjuagcmmezzz2a029gtldhey5k552/store?query_msg=eyJwb29sIjp7fX0%3D")
...
# #         {"native_token":
# #         {"denom":"uusd"}},
# #         "amount":"24392719692179"},
# #         {"info":{"native_token":{"denom":"uluna"}},"amount":"427502027715"}]
# #     ,"total_share":"1373423632643"
# #     }
# # }
...
# astro_query = requests.get(
#     'https://lcd.terra.dev/terra/wasm/v1beta1/contracts/terra1m6ywlgn6wrjuagcmmezzz2a029gtldhey5k552/store',
#     params={'query_msg':base64.b64encode('{"simulation":{"offer_asset":{"amount":"1000000","info":{"native_token":{"denom":"uusd"}}}}}'.encode("ascii")).decode("ascii")})
